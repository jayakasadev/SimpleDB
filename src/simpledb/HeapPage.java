...
public class HeapPage implements Page {
    ...
    public HeapPage(HeapPageId id, byte[] data) throws IOException {
        ...
        //System.out.println("Total Number of Slots " + this.numSlots);
        DataInputStream dis = new DataInputStream(new ByteArrayInputStream(data));

        // allocate and read the header slots of this page
        header = new int[(int)Math.ceil((float)numSlots/32)];//total number of columns
        for (int i=0; i<header.length; i++){
	       header[i] = dis.readInt();
	       //System.out.println("HEADER READ["+i+"]="+header[i]);
        }
        //System.out.println("TUPLES SETUP");
        try{
        	//System.out.println("TUPLES SETUP INSIDE");
        	...
        	//System.out.println("ERROR TUPLES EMPTY");
            //e.printStackTrace();
        }
        dis.close();
    ...
    private Tuple readNextTuple(DataInputStream dis, int slotId) throws NoSuchElementException {
    	//System.out.println("readNextTuple slotid" + slotId);
        ...
        if (!getSlot(slotId)) {
            ...
            for (int i=0; i<td.getSize(); i++) {
                try {
                    dis.readByte();
                    //System.out.println("Read " + dis.readByte());
                    //System.out.println("Read " + getSlot(slotId));
                } catch (IOException e) {
    ...
    public int getNumEmptySlots() {
    	...
    	//System.out.println("NumEmpty " + count);
    	return count;
    }
    /**
    ...
    public boolean getSlot(int i) {
	    //IMPLEMENT THIS
        //make sure you get correct input
    	//System.out.println("getSlot " + i);
    	int headerBit = i % 32; // remainder is offset into byte
		int headerByte = i / 32; // difference is the byte number
		//System.out.println(headerBit + " " + headerByte);
		//this line checks if the bit specified by headerbit's location is set
    ...
    private void setSlot(int i, boolean value){
	    //IMPLEMENT THIS
    	//System.out.println("setSlot " + i + " " + value);
    	int headerBit = i % 32; // remainder is offset into byte
		int headerByte = i / 32; // difference is the byte number
		//System.out.println(headerBit + " " + headerByte);
		//this line checks if the bit specified by headerbit's location is set
		if(value){
			//sets the bit to 1
			header[headerByte] = header[headerByte] | (1 << headerBit);
			return;
		}
		//sets the bit to 0
		header[headerByte] = header[headerByte] & ~(1 << headerBit);

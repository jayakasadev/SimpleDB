...
public class JoinTest {
    ...
    public void validateJoin(int table1ColumnValue, int table1Rows, int table2ColumnValue, int table2Rows) throws IOException, DbException, TransactionAbortedException {
    	...
    	//System.out.println("validateJoin");
    ...
    public void performJoin(int table1ColumnValue, int table1Rows, int table2ColumnValue, int table2Rows) throws IOException, DbException, TransactionAbortedException {

    	//System.out.println("performJoin");
    ...
    @Test public void testSingleMatch() throws IOException, DbException, TransactionAbortedException {
    	System.out.println("--------------------------------------------");
    	System.out.println("JoinTest - Test Single Match");
        validateJoin(1, 1, 1, 1);
    }

    @Test public void testNoMatch() throws IOException, DbException, TransactionAbortedException {
    	System.out.println("--------------------------------------------");
    	System.out.println("JoinTest - Test No Match");
        validateJoin(1, 2, 2, 10);
    }

    @Test public void testMultipleMatch() throws IOException, DbException, TransactionAbortedException {
    	System.out.println("--------------------------------------------");
    	System.out.println("JoinTest - Test Multiple Matches");
        validateJoin(1, 11, 1, 22);
    }

    @Test public void testLargeOuter() throws IOException, DbException, TransactionAbortedException {
    	System.out.println("--------------------------------------------");
    ...
    @Test public void testLargeInner() throws IOException, DbException, TransactionAbortedException {
    	System.out.println("--------------------------------------------");
    	System.out.println("JoinTest - Test Large Inner");
    	performJoin(1, 1, 1, 700);
    }

    @Test public void testLargeOuterInner() throws IOException, DbException, TransactionAbortedException {
    	System.out.println("--------------------------------------------");
    	System.out.println("JoinTest - Test Large Outer and Inner");

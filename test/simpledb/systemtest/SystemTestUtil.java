...
public class SystemTestUtil {
   ...
   /** @param columnSpecification Mapping between column index and value. */
    public static HeapFile createSortedFile(int columns, int rows, double duplicateProbability,
    ...
    /** @param columnSpecification Mapping between column index and value. */
    public static HeapFile createSortedFile(int columns, int rows, int maxValue, double duplicateProbability, 
            ArrayList<ArrayList<Integer>> tuples, boolean printTable)
            throws IOException, DbException, TransactionAbortedException {
    ...
    public static ArrayList<Integer> tupleToList(Tuple tuple) {
        ...
        //System.out.println("SystemTestUtil tupleToList " + list);
        return list;
    }

    public static void matchTuples(DbFile f, List<ArrayList<Integer>> tuples)
            throws DbException, TransactionAbortedException, IOException {
    	//System.out.println("matchTuples Dbfile");
    ...
    public static void matchTuples(DbFile f, TransactionId tid, List<ArrayList<Integer>> tuples)
            throws DbException, TransactionAbortedException, IOException {
    	//System.out.println("matchTuples Dbfile TransactionId");
    ...
    public static void matchTuples(DbIterator iterator, List<ArrayList<Integer>> tuples)
    	...
    	//System.out.println("matchTuples DbIterator");
        //System.out.println("matchTuples " + iterator.getClass());
